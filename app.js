...
const bookiDescription = "Construction d'un site web d'hébergement avec de simple language HTML et Css en reproduisant une maquette réalisé par un Web Designer"
...
const bruelDescription = "Amélioration d'un site statique en un site dynamique avec un panel de gestion administrateur pour gérer l'ensemble des opérations possible."
...
const kasaDescription = "Réalisation du Front-End d'un site de location d'hébergement avec React et Sass pour obtenir un site dynamique, performant et super ergonomique."
